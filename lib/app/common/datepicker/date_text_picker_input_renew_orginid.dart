...
class DateTextPickerInputReNewOrginId extends StatefulWidget {
  const DateTextPickerInputReNewOrginId({
    Key? key,
  ...
  @override
  State<DateTextPickerInputReNewOrginId> createState() =>
      _DateTextPickerInputState();
}

class _DateTextPickerInputState extends State<DateTextPickerInputReNewOrginId> {
