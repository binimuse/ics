...
class HomeController extends GetxController with SingleGetTickerProviderMixin {
  ...
  GetRenewTypePassportQuery getRenewPassportTypeQuery =
      GetRenewTypePassportQuery();
  ...
  void getRenewtypePassport() async {
    ...
    dynamic result =
        await graphQLCommonApi.query(getRenewPassportTypeQuery.fetchData(), {});

    startGettype(false);

    if (result != null) {
      basePassportRenewalType.value =
          (result['base_passport_renewal_types'] as List)
