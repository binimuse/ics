...
class Step4RenewPassport extends StatefulWidget {
  final IcsApplicationModelReNewPassport? citizenModel;
  final RenewPassportController controller;

  const Step4RenewPassport({
    this.citizenModel,
    required this.controller,
  });
  @override
  State<Step4RenewPassport> createState() => _Step4State();
}

class _Step4State extends State<Step4RenewPassport> {
  final RenewPassportController controller =
            ...
            GestureDetector(
              onTap: () {
                if (controller.familyModelvalue.length < 10 &&
                    controller.renewPassportformKey.currentState!.validate()) {
