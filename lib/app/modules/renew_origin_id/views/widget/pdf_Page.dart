...
class PdfPageReNewOriginId extends StatelessWidget {
  final BuildContext context;
  final RenewOriginIdController controller;
  final VoidCallback onTap;

  PdfPageReNewOriginId(
                        ...
                        child: Column(
                          children: [
                            ...
                            textText(
                                ...
                                title:
                                    '${controller.visanumberContoller.text.toString()}'),
                            textText(
                                subtitle: "visa  issue date",
                                title:
                                    '${controller.visaIssueDateController.text.toString()}'),
                            textText(
                                subtitle: "Visa  expiry date",
                                title:
                                    '${controller.visaExpiryDateController.text.toString()}'),
                            textText(
