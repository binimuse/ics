...
class ItemDocResidency extends StatefulWidget {
  const ItemDocResidency({
    super.key,
    required this.title,
  ...
  final List<ResidencyApplicationDocument> listOfDoc;
  ...
  @override
  State<ItemDocResidency> createState() => _ItemFaqState();
}

class _ItemFaqState extends State<ItemDocResidency> {
  ...
  buildPDFViewer(ResidencyApplicationDocument document) {
