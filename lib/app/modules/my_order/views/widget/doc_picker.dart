...
class _BuildDocState extends State<BuildDocForOrder> {
  ...
  Future<void> _handleFilePickedSuccess(PlatformFile pickedFile) async {
    ...
    if (responseUrl.isNotEmpty) {
      ...
      print(responseUrl);
      widget.controller
          .sendDoc(widget.documentType.id, responseUrl, widget.applicationId);
    } else {
