...
class IcsApplication {
    ...
    factory IcsApplication.fromMap(Map<String, dynamic> json) => IcsApplication(
        ...
        citizenFamilies: List<dynamic>.from(json["citizen_families"].map((x) => x)),
        ...
        applicationAppointments: List<ApplicationAppointment>.from(json["application_appointments"].map((x) => ApplicationAppointment.fromMap(x))),
        applicationDocuments: List<ApplicationDocument>.from(json["application_documents"].map((x) => ApplicationDocument.fromMap(x))),
        newOriginIdApplications: List<NewOriginIdApplication>.from(json["new_origin_id_applications"].map((x) => NewOriginIdApplication.fromMap(x))),
        newPassportApplications: List<NewPassportApplication>.from(json["new_passport_applications"].map((x) => NewPassportApplication.fromMap(x))),
        renewPassportApplications: List<RenewPassportApplication>.from(json["renew_passport_applications"].map((x) => RenewPassportApplication.fromMap(x))),
        renewalOriginIdApplications: List<RenewalOriginIdApplication>.from(json["renewal_origin_id_applications"].map((x) => RenewalOriginIdApplication.fromMap(x))),
    );
    ...
    Map<String, dynamic> toMap() => {
        ...
        "application_appointments": List<dynamic>.from(applicationAppointments.map((x) => x.toMap())),
        "application_documents": List<dynamic>.from(applicationDocuments.map((x) => x.toMap())),
        "new_origin_id_applications": List<dynamic>.from(newOriginIdApplications.map((x) => x.toMap())),
        "new_passport_applications": List<dynamic>.from(newPassportApplications.map((x) => x.toMap())),
        "renew_passport_applications": List<dynamic>.from(renewPassportApplications.map((x) => x.toMap())),
        "renewal_origin_id_applications": List<dynamic>.from(renewalOriginIdApplications.map((x) => x.toMap())),
    };
}
...
class ApplicationAppointment {
    ...
    factory ApplicationAppointment.fromMap(Map<String, dynamic> json) => ApplicationAppointment(
...
class ApplicationDocument {
    ...
    factory ApplicationDocument.fromMap(Map<String, dynamic> json) => ApplicationDocument(
...
class NewOriginIdApplication {
    ...
    factory NewOriginIdApplication.fromMap(Map<String, dynamic> json) => NewOriginIdApplication(
        createdAt: json["created_at"],
        applicationNo: json["application_no"],
        applicationId: json["application_id"],
        currentPassportExpiryDate: DateTime.parse(json["current_passport_expiry_date"]),
        currentPassportIssuedDate: DateTime.parse(json["current_passport_issued_date"]),
    ...
    Map<String, dynamic> toMap() => {
        ...
        "current_passport_expiry_date": "${currentPassportExpiryDate.year.toString().padLeft(4, '0')}-${currentPassportExpiryDate.month.toString().padLeft(2, '0')}-${currentPassportExpiryDate.day.toString().padLeft(2, '0')}",
        "current_passport_issued_date": "${currentPassportIssuedDate.year.toString().padLeft(4, '0')}-${currentPassportIssuedDate.month.toString().padLeft(2, '0')}-${currentPassportIssuedDate.day.toString().padLeft(2, '0')}",
...
class NewPassportApplication {
    ...
    factory NewPassportApplication.fromMap(Map<String, dynamic> json) => NewPassportApplication(
        createdAt: json["created_at"],
        applicationNo: json["application_no"],
    );
...
class RenewPassportApplication {
    ...
    factory RenewPassportApplication.fromMap(Map<String, dynamic> json) => RenewPassportApplication(
        passportNumber: json["passport_number"],
        applicationNo: json["application_no"],
        correctionType: json["correction_type"],
        passportRenewalType: CurrentCountry.fromMap(json["passport_renewal_type"]),
        id: json["id"],
    );
...
class RenewalOriginIdApplication {
    ...
    factory RenewalOriginIdApplication.fromMap(Map<String, dynamic> json) => RenewalOriginIdApplication(
        originIdRenewalType: CurrentCountry.fromMap(json["origin_id_renewal_type"]),
        applicationNo: json["application_no"],
        createdAt: json["created_at"],
        currentPassportNumber: json["current_passport_number"],
        visaNumber: json["visa_number"],
